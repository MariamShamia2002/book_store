  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <a class="btn btn-outline-dark w-25" href="addcategorey.php">add new categorey</a>
        ...
        <table class="table table-borderd table-hover table-striped">
          ...
          <tr>
            ...
            <td>
              <a  href="editcategorey.php?upd=<?php echo $row['id']?>" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
              <a href="categories.php?del=<?php echo $row['id']?>" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a>
            </td>
          </tr>
         <?php } ?>
        </table>
